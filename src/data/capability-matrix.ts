 ...
 * a layer built over it could add. Lab's facility graph and reviewed plan can
 * describe and allocate work across heterogeneous Assets; individual adapter
 * service levels are documented separately.
 */
