        ...
        <div className="mt-10 grid gap-10 sm:mt-14 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1fr)] lg:gap-16">
          <div>
            ...
            <p className="prose-lab mt-6 text-[15px] leading-[1.72] text-[#f6ece0]/60">
              Twelve of these exist today. Four are below, and the rest live in
              the repository. Changing how the language works starts with
              reading why it already works that way.
            </p>
