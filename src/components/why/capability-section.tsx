    ...
    <section className="border-t border-ink/12 bg-sand/40" id="compare">
      <SectionBody className="py-14 sm:py-20 lg:py-28">
        ...
        <p className="prose-lab mt-5 max-w-2xl text-[13.5px] leading-[1.7] text-umber-soft">
          ...
          add. Lab&rsquo;s facility artifact can describe and allocate across
          heterogeneous Assets; individual adapters still expose deliberately
          different planning, lowering, simulation, and runtime service levels.
        </p>
