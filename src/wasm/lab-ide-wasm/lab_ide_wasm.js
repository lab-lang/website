/* @ts-self-types="./lab_ide_wasm.d.ts" */

export class LabWorkspace {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        LabWorkspaceFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_labworkspace_free(ptr, 0);
    }
    /**
     * @param {string} source
     * @param {number} offset
    ...
    constructor() {
        const ret = wasm.labworkspace_new();
        this.__wbg_ptr = ret;
        LabWorkspaceFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @param {string} source
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./lab_ide_wasm_bg.js": import0,
    };
}

const LabWorkspaceFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_labworkspace_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('lab_ide_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
