    ...
    <>
        ...
        <div className="mx-auto max-w-[1480px] px-5 pb-20 pt-8 sm:px-8 sm:pt-10 lg:px-10 lg:pb-28">
          <Reveal className="flex items-center gap-2.5">
            ...
            <span className="micro text-umber">
              v0.1.0 · early prototype · built in the open
            </span>
          </Reveal>
          ...
          <div className="mt-9 grid gap-6 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-start">
            ...
            <Reveal className="lg:w-[474px] lg:shrink-0" delay={200}>
              <div className="flex flex-col gap-3 sm:flex-row">
                <Link
                  className="press inline-flex items-center justify-center gap-2 rounded-xl bg-ink px-5 py-3 text-[14px] text-paper shadow-[0_10px_24px_-8px_rgb(43_28_17_/_0.5)]"
                  to="/docs"
                >
                  Read the docs
                ...
                <Link
                  className="press inline-flex items-center justify-center gap-2 rounded-xl border border-ink/20 px-5 py-3 text-[14px] text-ink hover:border-ink/40"
                  to="/playground"
                >
                  Open the playground
                </Link>
      ...
      <section className="border-y border-ink/12 bg-sand/40" id="distinction">
        <div className="mx-auto max-w-[1480px] px-5 py-20 sm:px-8 lg:px-10 lg:py-28">
          ...
          <div className="mt-14 grid gap-10 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1fr)] lg:gap-16">
            ...
            <Reveal className="grid gap-4 sm:grid-cols-2" delay={140}>
      ...
      <section className="border-t border-ink/12" id="reactive">
        <div className="mx-auto max-w-[1480px] px-5 py-20 sm:px-8 lg:px-10 lg:py-28">
          ...
          <Reveal
            className="relative mt-10 overflow-hidden rounded-2xl border border-ink/20 bg-vessel"
            delay={80}
          >
            <div className="emission-wash pointer-events-none absolute inset-0" />

            <div className="relative grid lg:grid-cols-2">
              <div className="flex h-[480px] min-w-0 flex-col border-b border-white/10 sm:h-[620px] lg:border-b-0 lg:border-r">
              ...
              <div className="h-[480px] sm:h-[620px]">
                <ReactiveTimeline />
              </div>
            </div>
          </Reveal>
      ...
      <section className="mx-auto max-w-[1480px] px-5 py-20 sm:px-8 lg:px-10 lg:py-28" id="material-flow">
        <Reveal className="max-w-3xl">
        ...
        <div className="mt-12 grid gap-px overflow-hidden rounded-2xl border border-ink/15 bg-ink/12 sm:grid-cols-3">
          {ownership.map((mode, index) => (
            <Reveal
              className="bg-shell/70 p-6 sm:p-7"
              delay={index * 70}
              key={mode.mode}
            >
      ...
      <section className="border-t border-ink/12 bg-sand/40" id="status">
        <div className="mx-auto max-w-[1480px] px-5 py-20 sm:px-8 lg:px-10 lg:py-28">
          <div className="grid gap-12 lg:grid-cols-[minmax(0,0.85fr)_minmax(0,1fr)] lg:gap-20">
            ...
            <Reveal className="grid gap-10 sm:grid-cols-2" delay={90}>
              <div>
          ...
          <Reveal className="mt-16" delay={40}>
